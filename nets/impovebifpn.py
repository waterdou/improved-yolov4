...
from nets.utils import Conv2dStaticSamePadding, MaxPool2dStaticSamePadding, MemoryEfficientSwish, Swish
import torch
...
class BiFpn(nn.Module):
    def __init__(self, num_channels, conv_channels, first_time=False, epsilon=1e-4, onnx_export=False, attention=True,
        ...
        if self.first_time:
            ...
            self.p4_down_channel = nn.Sequential(
                Conv2dStaticSamePadding(128, num_channels, 1),
                nn.BatchNorm2d(num_channels, momentum=0.01, eps=1e-3),
            )
            self.p3_down_channel = nn.Sequential(
                Conv2dStaticSamePadding(64, num_channels, 1),
                nn.BatchNorm2d(num_channels, momentum=0.01, eps=1e-3),
            )
            ...
            self.p7_down_channel_2 = nn.Sequential(
                Conv2dStaticSamePadding(conv_channels[2], num_channels, 1),
                nn.BatchNorm2d(num_channels, momentum=0.01, eps=1e-3),
            )
    ...
    def _forward_fast_attention(self, inputs):
        if self.first_time:
            ...
            # if first time, we should require p6_in, p7_in, p3_in, p4_in, p5_in to sent Bi-fpn
